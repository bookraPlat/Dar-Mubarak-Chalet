...
function currentLanguage() {
  ...
  if (previousLanguage == 'Arabic'){
        ...
        const option1ItemContainerA = document.querySelector('.Dar-Mubarak-triple-container');
        option1ItemContainerA.classList.replace('Dar-Mubarak-triple-container' , 'Dar-Mubarak-triple-container-arabic');
        option1ItemContainerA.innerHTML = " <img src='ImagesFolder/Chalet-stay-icon.png' class='option1-icon'>ثلاثية دار مبارك";
        ...
        const option1ItemContainer = document.querySelector('.Dar-Mubarak-triple-container-arabic');
        option1ItemContainer.classList.replace('Dar-Mubarak-triple-container-arabic' , 'Dar-Mubarak-triple-container');
        option1ItemContainer.innerHTML = " <img src='ImagesFolder/Chalet-stay-icon.png' class='option1-icon'>  Dar-Mubarak Triple";
...
function dataExtraction(){
      ...
      services.forEach(service => {
        if (service.classList.contains('picked-service')){
          ...
          if (serviceName.trim() == "Dar Mubarak Triple" || serviceName.trim() == "ثلاثية دار مبارك"){
