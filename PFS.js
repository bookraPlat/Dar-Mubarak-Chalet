...
function currentLanguage(){
    ...
    if (languageStored =='Arabic') {
        ...
        portfolioName.innerHTML = 'دار مبارك';
        ...
        roleA.innerText = 'شالية دار مبارك';
        ...
        detailPhrase2.innerText = ' طريق 285📍';
        ...
        packageNameA.innerText = 'باقة الغروب';
        ...
        testimonialsIntroductionTitleA.innerText = 'زبائن شالية دار مبارك ';
        ...
        serviceCard2Description.innerHTML = ".جرب شعور الشالية";
        ...
        counterSectionDescriptionA.innerHTML = 'تسليط الضوء تفاصيل الشالية الرئيسية';
        ...
        counterCard1NumberA.innerHTML = '+8';
        ...
        counterCard2TitleA.innerHTML = 'دورين';
        ...
        counterCard2DescriptionA.innerHTML = "<p class = 'cc1al1'>بتفاصيل ممتعة</p>  <p class = 'cc1al2' >يشمل الشالية دورين </p>";  
        ...
        counterCard3NumberA.innerHTML = '+4';
        ...
        counterCard3DescriptionA.innerHTML = "<p class = 'cc1al1'>و وسائل تغطي إحتياجك في الشالية</p>  <p class = 'cc1al2' >من وسائل تسلية</p>";      
        ...
        bannerSectionTitleA.innerHTML = 'مكونات الشالية';
        ...
        bannerSectionDescriptionA.innerHTML = 'مكونات الشالية التي قد تسأل عنها.';
        ...
        bannerItem7Title.innerText = 'حديقة خلفية مع ألعاب أطفال ';

        const bannerItem8Title = document.querySelector('.banner-item8-title');
        bannerItem8Title.innerText = 'جلستين خارجية';

        const bannerItem8Title2 = document.querySelector('.banner-item8-title2');
        bannerItem8Title2.innerText = 'مقابل البحر';
        ...
        galleryIntroductionDescriptionA.innerHTML = '.لا تتردد في التمرير بمعرض الشالية ';
        ...
        const portfolioName = document.querySelector('.name');
        portfolioName.innerHTML = 'Dar Mubarak';
        ...
        roleA.style.alignItems = 'center';
        roleA.style.flexDirection = 'row';
        roleA.innerText = 'Dar Mubarak Chalet';

        const nameA = document.querySelector('.info-name');
        nameA.style.display = 'flex';
        nameA.style.alignItems = 'center';
        nameA.style.flexDirection = 'row';
        nameA.innerText = "Al-Khiran" ;

        const detailPhrase1 = document.querySelector('.detail-phrase1');
        detailPhrase1.innerText = 'Daily Rent 🗓️';

        const detailPhrase2 = document.querySelector('.detail-phrase2');
        detailPhrase2.innerText = 'Road 285📍';
        ...
        const packageNameA = document.querySelector('.package-name');
        packageNameA.innerText = 'Sunset Package';
        ...
        testimonialsIntroductionTitle.innerText = 'Customers Of Dar Mubarak Chalet';
        ...
        counterCard1Number.innerHTML = '+8';}
        ...
        counterCard3Number.innerHTML = '+4';}
        ...
        counterCard3Description.innerHTML = "more details to view  about our Dar Mubarak Chalet after booking button."; 
...
bannerSectionTitleA.classList.remove('banner-introduction-title-arabic');
        ...
        bannerSectionTitleA.innerHTML = 'Chalet Features ';
        ...
        const bannerItem1Title2 = document.querySelector('.banner-item1-title2');
        bannerItem1Title2.innerText = 'With Sea View';
        ...
        const bannerItem4Title = document.querySelector('.banner-item4-title');
        bannerItem4Title.innerText = "8 Master Bedrooms ";

        const bannerItem5Title = document.querySelector('.banner-item5-title');
        bannerItem5Title.innerText = 'Maids Master';

        const bannerItem5Title2 = document.querySelector('.banner-item5-title2');
        bannerItem5Title2.innerText = "Bedroom ";

        const bannerItem6Title = document.querySelector('.banner-item6-title');
        bannerItem6Title.innerText = 'Functional ';

        const bannerItem6Title2 = document.querySelector('.banner-item6-title2');
        bannerItem6Title2.innerText = 'Elevator';

        const bannerItem7Title = document.querySelector('.banner-item7-title');
        bannerItem7Title.innerText = 'Bathroom for bedrooms';

        const bannerItem8Title = document.querySelector('.banner-item8-title');
        bannerItem8Title.innerText = ' 2 Outdoor Seatings';

        const bannerItem8Title2 = document.querySelector('.banner-item8-title2');
        bannerItem8Title2.innerText = '+ Chairs & Umbrella ';

        const bannerItem9Title = document.querySelector('.banner-item9-title');
        bannerItem9Title.innerText = ' Private Swimming Pool';

        const bannerItem9Title2 = document.querySelector('.banner-item9-title2');
        bannerItem9Title2.innerText = 'With Sea View';

        const bannerItem10Title = document.querySelector('.banner-item10-title');
        bannerItem10Title.innerText = ' Children Play Area';

        const bannerItem10Title2 = document.querySelector('.banner-item10-title2');
        bannerItem10Title2.innerText = 'With Sea View';
        ...
        galleryIntroductionDescription.innerHTML = 'Feel free to view and scroll this gallery of Dar Mubarak Chalet.';}
