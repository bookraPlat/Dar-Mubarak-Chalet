...
function currentLanguage(){
    ...
    if (languageStored =='Arabic') {
        ...
        SampleTitleA.innerText = "مناظر من دار مبارك";
        ...
        SampleDescriptionA.innerHTML = 'مناظر من شالية دار مبارك.';
...
const SampleTitleA = document.querySelector('.sample-section-title');
SampleTitleA.innerText = "Views of Dar Mubarak";

const SampleLinkA = document.querySelector('.sample-section-link');
SampleLinkA.innerText = 'View more';

const SampleDescriptionA = document.querySelector('.sample-section-description');
SampleDescriptionA.innerHTML = 'These are glances of our Dar Mubarak Chalet';
...
const SampleTitleA = document.querySelector('.sample-section-title');
SampleTitleA.innerText = "Views of Dar Mubarak Chalet";
